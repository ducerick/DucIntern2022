...
void GSPlay::Init()
{
	...
	m_monsterLeft1->Set2DPosition(posLeft1, posRight1);
	m_monsterLeft1->SetSize(30, 40);
	m_monsterLeft2->Set2DPosition(posLeft2, posRight2);
	m_monsterLeft2->SetSize(30, 40);
	...
	m_monsterRight1->Set2DPosition(posLeft3, posRight3);
	m_monsterRight1->SetSize(30, 40);
	m_monsterRight2->Set2DPosition(posLeft4, posRight4);
	m_monsterRight2->SetSize(30, 40);
